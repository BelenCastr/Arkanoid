...
public class Config {
    ...
    public static final int DEADLINE_Y = 560;
    public static final int DEADLINE_HEIGHT = 8;
    ...
    public static final java.awt.Color BRICK_SPECIAL_COLOR = java.awt.Color.MAGENTA;
}